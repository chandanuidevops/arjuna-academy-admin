            ...
            <div class="col l12 m12 s12">
                <div class="row">
                    ...
                    <?php $this->load->view('include/pre-loader'); ?>
                        ...
                        <div class="row m0">
                            <div class="col l6 m6">
                                <p class="h5-para black-text m0">Add question for <?php echo (!empty($subject->subject))?$subject->subject:'';?> department</p>
                            </div>
                                    ...
                                    <form action="<?php echo base_url().'test/add_question_row';?>" method="post" style="overflow-y: auto;overflow-x: hidden;"
                                        ...
                                        <div class="row m0">
                                            <div class="input-field col s12 l6">
                                                ...
                                                <p>
                                                    <label>
                                                        <input class="dificulty" name="dificulty" type="radio" checked
                                                            value="easy" />
                                                        <span>Easy</span>
                                                    </label>
                                                    <label>
                                            ...
                                            <div class="input-field col s12 l3">
                                                ...
                                                <input type="hidden" id="per" value="<?php echo (!empty($total))?$total:''?>">
                                            </div>
                                            <div class="input-field col s12 l3" style="position:relative">
                                                ...
                                                <input type="hidden" id="old_sec" value="<?php echo (!empty($time_seconds))?$time_seconds:'0'?>">
                                            </div>
                                        </div>
                                        <div class="col s12">
                        ...
                        <div class="shorting-table">
                            ...
                            <div class="col l12 m12 s12">
                                ...
                                <p class="h5-para-p2">Note : minimum and maximum 12 questions mandatory <span class="red-text">*</span> </p>
                                
                                <table id="dynamic" class="striped">
                                    <thead>
                                        <tr class="tt">
                                            <th id="a" class="h5-para-p2" width="130px">Q. No.</th>
                                            <th id="a" class="h5-para-p2" width="130px">Dificulty</th>
                                            <th id="a" class="h5-para-p2" width="130px">Percent</th>
                                            <th id="a" class="h5-para-p2" width="130px">Duration</th>
        ...
        $('#question-form').submit(function(e) {
          ...
          if(parseInt(per)+parseInt(percent) <= 100  ){
              ...
              if(parseInt(old_sec)+parseInt(newSec) <= 3600){
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url().'test/add_question_row';?>",
                    data: {
                        percent: percent,
                        sub_id: sub_id,
                        duration: duration,
                    ...
                    success: function(response) {
                        ...
                        if (response != '') {
                           ...
                           loadData();
                            M.toast({
                                html: 'Question group added succesfully',
                                classes: 'green',
                                displayLength: 5000
                            });
                        } else {
                ...
                alert('Time alloted to this question could not exceed to 60 minutes')
              }
        ...
        function loadData() {
            ...
            $.ajax({
               ...
               secondsToMinutes(total)
                        ...
                        displayData = displayData.add('<tr> <td>'+count+'</td> <td>'+data[i].dificulty+' </td> <td> '+data[i].percent+'</td> <td>'+data[i].duration+' </td>  <td class="action-btn center-align"> <a href="<?php echo base_url()?>test/edit-question-row/'+data[i].uniq+'/'+sub_id+'" class="blue hoverable delete-btn "><i class="fas fa-edit "></i></a><a href="<?php echo base_url()?>test/add-question/'+data[i].id+'/'+sub_id+'" class="blue hoverable delete-btn "><i class="fas fa-plus "></i></a> <a    href="<?php echo base_url()?>test/delete_question_row/'+data[i].id+'/'+data[i].sub_id+' " class="red hoverable delete-btn delete" id="delete"><i class="fas fa-trash "></i></a> </td> </tr>')
                    }
        ...
        $.ajax({
            ...
            success: function(data) {
                 ...
                 if(data==true){
                  ...
                  loadData();
                  M.toast({
                    html: 'Question group deleted succesfully',
                    classes: 'green',
                    displayLength: 5000
                });
