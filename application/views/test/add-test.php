            ...
            <div class="col l12 m12 s12">
                <div class="row">
                    ...
                    <?php $this->load->view('include/pre-loader'); ?>
                        ...
                        <div class="row m0">
                            <div class="col l6 m6">
                                <p class="h5-para black-text m0">Add Subject</p>
                            </div>
                                ...
                                <table id="dynamic" class="striped">
                                    <thead>
                                        <tr class="tt">
                                            ...
                                            <th id="a" class="h5-para-p2" width="130px">Subject</th>
    ...
    $(document).ready(function() {
        ...
        $('#subject-form').submit(function(e) {
            ...
            if (subject != '') {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url().'test/add_subject';?>",
                    data: {
                        subject: subject,
                        uniq: uniq
                    },
                    ...
                    success: function(response) {
                        ...
                        if (response == true) {
                            ...
                            loadData();
                            M.toast({
                                html: 'Subject added succesfully',
                                classes: 'green',
                                displayLength: 5000
                            });
                        } else {
        ...
        function loadData() {
            $.ajax({
                url: "<?php echo base_url().'test/display_subject';?>",
                type: "POST",
                dataType: 'json',
...
$("#displayData").on('click', '.delete', function(event) {
    ...
    success: function(data) {
         ...
         if(data==true){
          tr.remove();
          M.toast({
            html: 'Subject  deleted succesfully',
            classes: 'green',
            displayLength: 5000
        });
