            ...
            <div class="col l12 m12 s12">
                <div class="row">
                    ...
                    <div class="col m12 s12 l9">
                        ...
                        <div class="row m0">
                            <div class="col l6 m6">
                                <p class="h5-para black-text m0">User -
                                ...
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a
                                                    href="mailto:<?php echo (!empty($result->email))?$result->email:'---'  ?>"><?php echo (!empty($result->email))?$result->email:'---'  ?></a></td>
                                        </tr>
                                        <tr>
                                            <th class="w205">School</th>
                                            <td><?php echo (!empty($result->school))?$result->school:'---'  ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="w205">Father's Name</th>
                                            <td><?php echo (!empty($result->father))?$result->father:'---'  ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="w205">Father's Mobile</th>
                                            <td><a
                                                    href="tel:<?php echo (!empty($result->father_mobile))?$result->father_mobile:'---'  ?>"><?php echo (!empty($result->father_mobile))?$result->father_mobile:'---'  ?></a></td>
                                        </tr>
                                        
                                        <tr>
                                            <th class="w205">Mother's Name</th>
                                            <td><?php echo (!empty($result->mother))?$result->mother:'---'  ?></td>
                                        </tr>
                                        <tr>
                                            <th class="w205">Mother's Mobile</th>
                                            <td>
                                            <a href="tel:<?php echo (!empty($result->mother_mobile))?$result->mother_mobile:'---'  ?>"><?php echo (!empty($result->mother_mobile))?$result->mother_mobile:'---'  ?></a>
                                        </tr>
                                        <tr>
                                            <th class="w205">Interview Date</th>
                                            <td><?php echo (!empty($result->date))?$result->date:'---'  ?></td>
                                        </tr>
                                        <tr>
                                            <th class="w205">Interview Time</th>
