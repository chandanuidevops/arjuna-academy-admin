         ...
         <div class="container-wrap">
            <div class="row">
              ...
              <div id="sidemenu-include">
               ...
               <div class="row ">
                            <div class="col l6 m6">
                                <p class="h5-para black-text m0">Student Interview Schedule</p>
                            </div>
                     ...
                     <div class="shorting-table">
                        <div>
                           <div class="col l12 m12 s12">
                              <div class="">
                                 <p class="h5-para-p2">Interview Schedule List</p>
                                <table id="dynamic" class="striped">
                                    ...
                                    if (!empty($result)) {
                                      ...
                                      ?>
                                      <tr>
                                            <td ><a href="<?php echo base_url('test/view-student/'.$value->id.'') ?>"><?php echo (!empty($result))?$count:'---'  ?></a></td>
                                            <td ><a href="<?php echo base_url('test/view-student/'.$value->id.'') ?>"><?php echo (!empty($value->name))?$value->name:'---'  ?></a></td>
                                            <td ><a href="<?php echo base_url('test/view-student/'.$value->id.'') ?>"><?php echo (!empty($value->email))?$value->email:'---'  ?></a></td>
                                            <td><a href="<?php echo base_url('test/view-student/'.$value->id.'') ?>"><?php echo (!empty($value->date))?date("M d, Y ", strtotime($value->date)):'---'; ?></a></td>
                                            <td ><a href="<?php echo base_url('test/view-student/'.$value->id.'') ?>"><?php echo (!empty($value->time))?$value->time:'---'  ?></a></td>
                                        
                                           
                                            <td class="action-btn  center-align">
                                              <!-- view user -->
                                                <a href="<?php echo base_url('test/view-student/'.$value->id.'') ?>"  class="blue hoverable"><i class="fas fa-eye "></i></i></a>

                                                <a  href="<?php echo base_url('test/delete_student_schedule/'.$value->id.'') ?>"  class="red hoverable delete"><i class="fas fa-trash "></i></i></a>
                                              <!-- view user -->
                                            </td>
