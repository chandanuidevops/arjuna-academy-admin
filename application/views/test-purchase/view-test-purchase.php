                            ...
                            <div class="card-content">
                                ...
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            <th class="w205">Payment Id</th>
                                            <td><?php echo (!empty($result->pay_id))?$result->pay_id:'---'  ?></td>
                                        </tr>



                                        <tr>
                                            <th class="w205"> Purchased date</th>
                                            <td><?php echo (!empty($result->purchase_date))?date("M d, Y ", strtotime($result->purchase_date)):'---'; ?>
                                            </td>
                                        </tr>
