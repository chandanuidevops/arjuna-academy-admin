                  ...
                  <?php $this->load->view('include/pre-loader.php'); ?>
                    <div class="row">
                                ...
                                <div class="col 12 m6 right-align">
                                    <a href="<?php echo base_url('home-gallery/add-home-gallery')  ?>" class="waves-effect waves-light btn green darken-4 white-text hoverable "><i class="fas fa-plus left"></i> ADD Home Gallery </a>
                                </div>
                            </div>
                                ...
                                <table id="dynamic" class="striped">
                                    ...
                                    <?php if (!empty($result)) { $count = 0; foreach ($result as $key => $value) { $count = $count+1; ?>
                                      ...
                                      <td ><?php echo (!empty($result))?$count:'---'  ?></td>
                                            ...
                                            <td ><img class="table-image" src="<?php echo $this->config->item('web_url').$value->thumb_image; ?>" alt="image"></td>                                    
                                            <td class="action-btn  center-align">
                                              
                                              <!-- delete user -->
                                                <a  href="<?php echo base_url('home-gallery/edit-home-gallery/'.$value->id.'') ?> " class="blue hoverable delete-btn"><i class="fas fa-edit  "></i></a>
                                               
                                                <a  href="<?php echo base_url('home_gallery/delete/'.$value->id.'') ?> " class="red hoverable delete-btn delete"><i class="fas fa-trash  "></i></a>
                                                <!-- delete user -->
                                            </td>
