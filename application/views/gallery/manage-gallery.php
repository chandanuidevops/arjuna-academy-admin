                  ...
                  <?php $this->load->view('include/pre-loader.php'); ?>
                    <div class="row">
                                ...
                                <div class="col 12 m6 right-align">
                                    <a href="<?php echo base_url('gallery/add-gallery')  ?>" class="waves-effect waves-light btn green darken-4 white-text hoverable "><i class="fas fa-plus left"></i> ADD Gallery </a>
                                </div>
                            </div>
                     ...
                     <div class="shorting-table">
                        <div>
                           <div class="col l12 m12 s12">
                              <div class="">
                                 <p class="h5-para-p2">Manage Gallery </p>
                                <table id="dynamic" class="striped">
                                    <thead>
                                       <tr class="tt">
                                          ...
                                          <th id="c" class="h5-para-p2" width="120px">Home Gallery</th>
                                    ...
                                    <?php if (!empty($result)) { $count = 0; foreach ($result as $key => $value) { $count = $count+1; ?>
                                      ...
                                      <td ><?php echo (!empty($result))?$count:'---'  ?></td>
                                            ...
                                            <td ><img class="table-image" src="<?php echo $this->config->item('web_url').$value->feat_image; ?>" alt="image"></td>
                                            <td ><?php echo (!empty($value->home_gallery=='1'))?'Active':'Disabled'  ?></td>                                                                        
                                            <td class="action-btn  center-align">
                                              
                                              <!-- delete user -->
                                                <a  href="<?php echo base_url('gallery/edit-gallery/'.$value->id.'') ?> " class="blue hoverable delete-btn"><i class="fas fa-edit  "></i></a>
                                               
                                                <a  href="<?php echo base_url('gallery/delete/'.$value->id.'') ?> " class="red hoverable delete-btn delete"><i class="fas fa-trash  "></i></a>
                                                <!-- delete user -->
                                            </td>
                   ...
                   $.ajax({
                       ...
                       success: function(data) {
                            ...
                            if(data==true){
                             tr.remove();
                             M.toast({
                               html: 'Gallery image deleted succesfully',
                               classes: 'green',
                               displayLength: 5000
                           });
