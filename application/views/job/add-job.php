            ...
            <div class="col l12 m12 s12">
                <div class="row">
                    ...
                    <div class="col m12 s12 l9">
                        ...
                        <div class="row m0">
                            <div class="col l6 m6">
                            <p class="h5-para black-text  m0">Add Job</p>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="form-container">
                                    <form action="<?php echo base_url() ?>job/insert" method="post"
                                        ...
                                        <div class="row m0">
                                            <div class="input-field col s12 l6">
                                                <input type="text" id="job_title" name="job_title" class="validate" required>
                                                <label for="job_title">Job Title<span class="red-text">*</span></label>
                                            </div>
                                            <div class="input-field col s12 l6">
                                                <input type="text" id="job_type" name="job_type" class="validate" required>
                                                <label for="job_type">Job Type<span class="red-text">*</span></label>
                                            </div>
                                            <div class="input-field col s12 l6">
                                                <input type="text" id="qualification" name="qualification" class="validate" required>
                                                <label for="qualification">Qualification<span class="red-text">*</span></label>
                                            </div>
                                            <div class="input-field col s12 l6">
                                                <input type="text" id="experience" name="experience" class="validate " required>
                                                <label for="experience">Experience<span class="red-text">*</span></label>
                                            </div>
                                           
                                            <div class="input-field col s12 l12">
                                                    <p for="" class="mb10">Skills</p>
                                                    <input name="job_skill" id="tags" value="" required/>
                                                </div>
                                           
                                           
                                            <div class="input-field col s12 l12">
                                            
                                            <p for="" class="mb10">Job description</p>
                                                <textarea    name="job_description" id="job_description" class="validate ckeditor" required></textarea >
                                               
                                            </div>
                                            
                                            <div class="input-field col s12 l12">
                                           
                                                <p for="" class="mb10">Job Responsibility</p>
                                                <textarea name="job_responsibility" id="job_responsibility" class="ckeditor" required></textarea>
                                            </div>

                                            <div class="input-field col s12 l12">
                                                
                                                <p for="" class="mb10">Job Requirements</p>
                                                <textarea name="job_requirement" id="job_requirement" class="ckeditor" required></textarea>
...
$(document).ready(function() {
   $('#job-form').submit(function(e) {
            ...
            job_description != '' && tags != '' && job_responsibility != '' && job_requirement != '') {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url().'job/insert';?>",
