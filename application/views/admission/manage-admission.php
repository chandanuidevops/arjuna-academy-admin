              ...
              <div id="sidemenu-include">
               ...
               <div class="col m12 s12 l9">
                  ...
                  <?php $this->load->view('include/pre-loader.php'); ?>
                    <div class="row ">
                                <div class="col 12 m3">
                                    <p class="h5-para black-text m0">Admission  List</p>
                                </div>
                                ...
                                <!-- <a href="<?php echo base_url('test/view-schedule')  ?>" class="waves-effect waves-light btn green darken-4 white-text hoverable "><i class="fas fa-user left"></i>View Schedule </a>
                                    ...
                                    <a href="<?php echo base_url('admission/add-admission-amount')  ?>" class="waves-effect waves-light btn green darken-4 white-text hoverable "><i class="fas fa-plus left"></i> ADD/EDIT ADMISSION AMOUNT</a>
                                </div>
                            </div>
                     ...
                     <div class="shorting-table">
                        <div>
                           <div class="col l12 m12 s12">
                              <div class="">
                                 <p class="h5-para-p2">Manage Admission </p>
                                <table id="dynamic" class="striped">
                                    <thead>
                                       <tr class="tt">
                                          <th id="a" class="h5-para-p2" width="130px">Si No.</th>
                                          <th id="c" class="h5-para-p2" width="120px">Name</th>
                                          <th id="c" class="h5-para-p2" width="120px">Admission Type</th>
                                          <th id="c" class="h5-para-p2" width="120px">Payment Status</th>
                                    ...
                                    <?php if (!empty($result)) { $count = 0; foreach ($result as $key => $value) { $count = $count+1; ?>
                                      ...
                                      <td ><?php echo (!empty($result))?$count:'---'  ?></td>
                                            <td><a href="<?php echo base_url('admission/view/'.$value->id.'') ?>"><?php echo (!empty($value->name))?$value->name:'---'  ?></a></td>
                                            <td><a href="<?php echo base_url('admission/view/'.$value->id.'') ?>"><?php    if($value->admission_type =='ssc'){  echo 'Class 8, 9 & 10';    }else{   echo 'Class 11 or 1st PUC';   } ?></a></td>
                                            <td><a href="<?php echo base_url('admission/view/'.$value->id.'') ?>"> <?php 
                                             if(!empty($value->pay_id) && !empty($value->amount) ){ ?>
                                            ...
                                            <td ><a href="<?php echo base_url('admission/view/'.$value->id.'') ?>"><?php echo (!empty($value->created_on))?date("M d, Y ", strtotime($value->created_on)):'---'; ?></a></td>                           
                                            <td class="action-btn  center-align">
                                            <a  href="<?php echo base_url('admission/view/'.$value->id.'') ?> " class="blue hoverable delete-btn" ><i class="fas fa-eye"></i></a>
                                             <a  href="<?php echo base_url('admission/delete_admission/'.$value->id.'') ?> " class="red hoverable delete delete-btn"><i class="fas fa-trash  "></i></a> 
                                            </td>
                                        </tr>
                   ...
                   $.ajax({
                       ...
                       success: function(data) {
                            ...
                            if(data==true){
                             tr.remove();
                             M.toast({
                               html: 'Admission deleted Successfully',
                               classes: 'green',
                               displayLength: 5000
                           });
