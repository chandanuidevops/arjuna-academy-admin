              ...
              <div id="sidemenu-include">
               ...
               <div class="col m12 s12 l9">
                  ...
                  <?php $this->load->view('include/pre-loader.php'); ?>
                    <div class="row">
                                <div class="col 12 m6">
                                    <p class="h5-para black-text m0">Course  List</p>
                                </div>
                                <div class="col 12 m6 right-align">
                                    <a href="<?php echo base_url('course/add-course')  ?>" class="waves-effect waves-light btn green darken-4 white-text hoverable "><i class="fas fa-plus left"></i> ADD Course </a>
                                </div>
                            </div>
                                    ...
                                    <?php if (!empty($result)) { $count = 0; foreach ($result as $key => $value) { $count = $count+1; ?>
                                      ...
                                      <td ><?php echo (!empty($result))?$count:'---'  ?></td>
                                            ...
                                            <td class="action-btn  center-align">
                                              ...
                                              <a  href="<?php echo base_url('course/add-testimonial/'.$value->id.'') ?> " class="blue hoverable delete-btn tooltipped" data-position="top" data-tooltip="Add testimonial" ><i class="fas fa-plus  "></i></a>
                                              <a  href="<?php echo base_url('course/edit-course/'.$value->id.'') ?> " class="blue hoverable delete-btn" ><i class="fas fa-edit  "></i></a>
                                               
                                                <a  href="<?php echo base_url('course/delete/'.$value->id.'') ?> " class="red hoverable delete-btn delete"><i class="fas fa-trash  "></i></a>
                                                <!-- delete user -->
                                            </td>
                   ...
                   $.ajax({
                       ...
                       success: function(data) {
                            ...
                            if(data==true){
                             tr.remove();
                             M.toast({
                               html: 'Course deleted succesfully',
                               classes: 'green',
                               displayLength: 5000
                           });
