                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="form-container">
                                    <form action="<?php echo base_url() ?>course/insert_testimonial" method="post"
                                        ...
                                        <div class="row m0">
                                            ...
                                            <div class="input-field col s12 l6">
                                                <input type="text" id="rank" name="rank" class="validate" required>
                                                <label for="rank">Rank<span class="red-text">*</span></label>
                                            </div>
                                            <div class="input-field col s12 l6">
                                                <input type="text" id="college" name="college" class="validate" required>
                                                <label for="college">College<span class="red-text">*</span></label>
                                            </div>
                                            <div class="input-field col s12 l12">
                                                <textarea type="text" maxlength="500" id="description" name="description" class="validate materialize-textarea" required></textarea>
 ...
 <script>
    ...
    $(document).ready(function() {
        ...
        $('#testimonial-form').submit(function(e) {
            ...
            if (name != '' && course != '' && rank != '' && college != '' &&
            description != ''  && testimonial_img >0) {
                loder(true)
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url().'course/insert_testimonial';?>",
                    ...
                    success: function(response) {
                        ...
                        if (response ==true) {
                            ...
                            M.toast({
                                html: 'Testimonial added succesfully',
                                classes: 'green',
                                displayLength: 5000
                            });
