                              ...
                              <div class="">
                                ...
                                <table id="dynamic" class="striped">
                                    ...
                                    if (!empty($result)) {
                                      ...
                                      ?>
                                      <tr>
                                            <td ><a href="<?php echo base_url('enquiry/view/'.$value->id.'') ?>"><?php echo (!empty($result))?$count:'---'  ?></a></td>
                                            <td ><a href="<?php echo base_url('enquiry/view/'.$value->id.'') ?>"><?php echo (!empty($value->name))?$value->name:'---'  ?></a></td>
                                            <td ><a href="<?php echo base_url('enquiry/view/'.$value->id.'') ?>"><?php echo (!empty($value->email))?$value->email:'---'  ?></a></td>
                                            <td ><a href="<?php echo base_url('enquiry/view/'.$value->id.'') ?>"><?php echo (!empty($value->phone))?$value->phone:'---'  ?></a></td>
                                            <td ><a href="<?php echo base_url('enquiry/view/'.$value->id.'') ?>"><?php echo (!empty($value->course))?$value->course:'---'  ?></a></td>
                                            <td ><a href="<?php echo base_url('enquiry/view/'.$value->id.'') ?>"><?php echo (!empty($value->message))?$value->message:'---'  ?></a></td>
                                            <td><a href="<?php echo base_url('enquiry/view/'.$value->id.'') ?>"><?php echo (!empty($value->date))?date("M d, Y ", strtotime($value->date)):'---'; ?></a></td>
                                            <td class="action-btn  center-align">
                                              <!-- view user -->
                                                <a href="<?php echo base_url('enquiry/view/'.$value->id.'') ?>"  class="blue hoverable"><i class="fas fa-eye "></i></i></a>

                                                <a  href="<?php echo base_url('enquiry/delete/'.$value->id.'') ?>"  class="red hoverable delete"><i class="fas fa-trash "></i></i></a>
                                              <!-- view user -->
                                            </td>
                   ...
                   $.ajax({
                       ...
                       success: function(data) {
                            ...
                            if(data==true){
                             tr.remove();
                             M.toast({
                               html: 'Enquiry deleted Successfully',
                               classes: 'green',
                               displayLength: 5000
                           });
