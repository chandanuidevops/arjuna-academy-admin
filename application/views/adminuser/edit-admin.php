                            ...
                            <div class="card">
                                <div class="card-content">
                                    <div class="form-container">
                                        <form action="<?php echo base_url() ?>adminuser/update" method="post"  id="admin-form" enctype="multipart/form-data">
                                            ...
                                            <div class="row m0">
                                              <div class="input-field col s12 l6">
                                                <p>Admin Type</p>
                                                  <p>
                                                    <label>
                                                      <input class="with-gap" name="admintype" type="radio" value="2" <?php echo ($result->admin_type == '2')?'checked':''; ?> />
                                                      <span>Sub Admin</span>
                                                    </label>
                                                    <label>
                                                      <input class="with-gap" name="admintype" type="radio" value="1" <?php echo ($result->admin_type == '1')?'checked':''; ?>/>
                                            ...
                                            <div class="row m0">
                                              <div class="input-field col s12 l6">
                                                <p>Admin Status</p>
                                                  <p>
                                                    <label>
                                                      <input class="with-gap" name="active" type="radio" value="1" <?php echo ($result->is_active == '1')?'checked':''; ?> />
                                                      <span>Active</span>
                                                    </label>
                                                    <label>
                                                      <input class="with-gap" name="active" type="radio" value="" <?php echo ($result->is_active == '0')?'checked':''; ?>/>
                                                      <span>Inactive</span>
                                                    </label>
                                                  </p>
                                              </div>
